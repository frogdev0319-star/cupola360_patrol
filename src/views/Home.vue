            ...
            items: [
              {
                id: 48247,
                subject:
                  "Provide and maintain appropriate environmental conditions (air conditioning, humidity, and temperature).",
                description: "",
                itemScore: 10,
                qualifiedScore: 0,
                sequence: 48247,
              ...
              },
              {
                id: 48248,
                subject:
                  "Ensure that all storage areas are provided with fire safety and security systems.",
                description: "",
                itemScore: 10,
                qualifiedScore: 0,
                sequence: 48248,
            ...
            items: [
              {
                id: 48250,
                subject:
                  "Have the hazards that were identified last month been corrected? (If “NO”, specify which hazards by adding a note)",
                description: "",
                itemScore: -10,
                qualifiedScore: 0,
                sequence: 48250,
